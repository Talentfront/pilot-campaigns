...
```mermaid
xychart-beta
    title "Top 10 Winner Scores"
    x-axis ["DXDougNoQU5","DW9ebHtPnBL","DW44MSXDd5n","DXACv8kmL-m","DW4VNdsDuPA","DW28Wv1kjmN","DW40azaiJZ1","DW3elyYjcp2","DXAK2BrkttL","DW3PN7dCL-0"]
    y-axis "score" -0.5 --> 1.0
    bar [0.5,0.25,0.143,0.115,0.062,0.0,0.0,0.0,0.0,-0.083]
```